<template>
  <f7-page @page:afterin="onPageAfterIn">
    ...
    <f7-list form v-if="rosterItem && rosterQuestion">
      <template v-for="question in rosterQuestion.questions" :key="question.id">
        <div class="form-group">
          ...
          <!-- Nested Roster -->
          <RosterList 
            v-else-if="question.type === 'roster'"
            :rosterQuestion="question"
            :rosterData="rosterItem[question.id] || []"
    ...
    <f7-block>
      <f7-button fill large @click="saveAndGoBack">Simpan</f7-button>
    </f7-block>
